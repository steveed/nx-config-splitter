...
describe('integration', () => {
  ...
  it('should write to tsconfig project config file', async () => {
    ...
    runner.runSchematicAsync('writer', {
      rootDirectory: 'libs',
      fileName: 'tsconfig',
      keyPath: 'compilerOptions.paths',
      name: 'project1'
    }, testTree).subscribe((tree) => {
      const data = JSON.parse(tree.readContent('libs/project1/project.config.json') as any) as ProjectConfigFile;
